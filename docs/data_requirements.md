...
## Ограничения модели XTTS-v2
- Подготавливайте текстовые запросы длиной не более 400 токенов (примерно 250 символов), чтобы избежать обрезки или деградации синтеза.
- Ограничивайте длительность каждого аудиофайла 30 секундами; оптимальный диапазон — 2–10 секунд для устойчивой сегментации и качества.
- Соблюдайте суммарный объём материала в пределах 20–60 минут на голос: это соответствует требованиям к данным и рекомендациям по обучению.

Подробные рекомендации и примеры пайплайна приведены в [training_guide.md](training_guide.md).
